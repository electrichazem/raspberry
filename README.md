...
- `sensor_tests/system_step3_servos_relay6.py` moves servos from 0° to 90° and turns on relay P6, keeping all previous outputs ON (third step of full-system sequence).
