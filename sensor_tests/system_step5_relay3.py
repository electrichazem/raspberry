#!/usr/bin/env python3
"""
System step 5 test: turn on relay 3 (P3), keeping all previous outputs ON.
...
Usage:
    python3 sensor_tests/system_step5_relay3.py
"""
...
RELAY_3_INDEX = 3  # turn ON in step 5
...
def main() -> None:
    ...
    print("Step 5: Turn ON Relay 3 (P3) - keeping all previous outputs ON\n")
